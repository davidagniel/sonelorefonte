  ...
  <div class="row">
    ...
    <div class="card-body">
      <div class="table-responsive">
        <table class="table table-striped md-6 text-center">
          <thead>
            <tr>
              <th></th>
              <th>Certification</th>
          ...
          <tbody>
            <tr>
              <td><img src="image/ss4.svg" width="50" height="50" alt="ss4"></td>
              <td>Sous amiante 4</td>
              <td>initiale</td>
              <td>10/10/2021</td>
...
<div class="card-body">
  <div class="table-responsive">
    <table class="table table-striped text-center">
      ...
      <tbody>
        <tr>
          <td><img src="image/audit.svg" width="50" height="50" alt="ss4"></td>
          <td>audit</td>
          <td>initiale</td>
          <td>10/10/2021</td>
          <td class="text-white" style="background-color:#fd7e14;">10/10/2025</td>
